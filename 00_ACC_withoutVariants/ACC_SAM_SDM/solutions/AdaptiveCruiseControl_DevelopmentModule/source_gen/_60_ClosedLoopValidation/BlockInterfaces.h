 ...
 */
typedef void ((*(BlockInterfaces____ssd_safe_distance_computationInterface_newBlock_executeFunctionTypedef))(void *,double ,double ,double *));
/* 
 * This computes the safe distance between the ACC and leading vehicle
 */
typedef void ((*(BlockInterfaces____ssd_safe_distance_computationInterface_newBlock_updateFunctionTypedef))(void *,double ,double ));
/* 
...
typedef void ((*(BlockInterfaces____acc_controlInterface_polo_executeFunctionTypedef))(void *,uint8_t ,double ,double ,double ,double ,double *,double *,double *,double *));
typedef void ((*(BlockInterfaces____acc_controlInterface_polo_updateFunctionTypedef))(void *,uint8_t ,double ,double ,double ,double ));
