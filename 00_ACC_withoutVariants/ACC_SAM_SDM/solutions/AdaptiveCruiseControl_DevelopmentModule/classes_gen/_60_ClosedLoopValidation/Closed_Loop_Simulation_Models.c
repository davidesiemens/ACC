...
{
  {
...

    {
      ...
      ___id->__preconditionFailed_v_ref_positive = false;
  ...
  ___id->i_ssd_safe_dist_compute.T_SAFE_hatchback = 2.0;
  /* 
   * initializing parameters
   */
...
static void  Closed_Loop_Simulation_Models___testhelper____completeSystem_SimulationBlock____blockunittest__0_unittest(void *___data, void *___blockExecIfFn, void *___blockUpdateIfFn, int32_t *___failures) 
{
  ...
  instance.___simIncr = 0.1;
  Closed_Loop_Simulation_Models____completeSystem_flattened_init(&instance);
  ___id = &instance;
  id = "0";
  path = "C:/Users/tghx1e/CHE-W14-005/00_Demos/00_ACC_withoutVariants/ACC_SAM_SDM/solutions/AdaptiveCruiseControl_DevelopmentModule/source_gen/_60_ClosedLoopValidation/CLSResults.xml";
  ...
  ___SimulationRuntime_initTimeVars(0.0, 0.1);
...
void  Closed_Loop_Simulation_Models____control_flattened_execute(Closed_Loop_Simulation_Models____control_flattened_data_t *___id, uint8_t ACC_switch, double d_lead_hatchabck, double v_acc, double v_lead, double v_ref, double *brake, double *d_brake, double *d_safe_new, double *throttle) 
{
  ...
  }
  {
    ...
    if ( !__assertCondition ) 
    {
      ___id->__preconditionFailed_v_ref_positive = true;
      ___BlockMessages____block_messagelist_Contract_Failed("Closed_Loop_Simulation_Models_control_flattened_v_ref_positive", "Closed_Loop_Simulation_Models:control_flattened:1?r:f599b715-12fa-44c1-a288-a72fd0bffe50(_30_Architecture)#6427938858666182803");
      printf("v_ref=%f\n",v_ref);;
      printf("v_ref=%f\n",v_ref);;
    }
  }
  ...
  {
    bool __assertCondition;
    __assertCondition = (d_lead_hatchabck > 0.0);
    if ( !__assertCondition ) 
    {
      ...
      printf("d_lead_hatchabck=%f\n",d_lead_hatchabck);;
    }
  }
  ___id->__anyPreconditionFailed = (___id->__preconditionFailed_ACC_on) || (___id->__preconditionFailed_v_ref_positive) || (___id->__preconditionFailed_v_acc_positive) || (___id->__preconditionFailed_d_lead_positive);
  {
    {
    ...
    }
    {
      ...
      {
        ACC_SafeDistance_Atomic____ssd_distance_error_execute(&(___id->i_ssd_dist_error), d_lead_hatchabck, (___id->ssd_safe_dist_compute_d_safe), &(___id->ssd_dist_error_d_error));
      };
    ...
    }
    {
      ...
      {
        ACC_SafeDistance_Atomic____ssd_mode_compute_execute(NULL, d_lead_hatchabck, (___id->ssd_safe_dist_compute_d_safe), &(___id->ssd_mode_compute1_ssd_mode));
      };
    ...
    }
    {
      ...
      {
        ACC_SpeedTracking_Atomic____st_mode_computation_execute(NULL, (___id->st_mode_braking_distance_d_brake), d_lead_hatchabck, (___id->ssd_safe_dist_compute_d_safe), v_acc, (___id->ssd_setpoint1_v_set), &(___id->st_mode_compute_st_mode));
      };
  ...
  {
    bool __assertCondition;
    __assertCondition = !(((d_lead_hatchabck < (*d_brake)) && ((*d_safe_new) < (*d_brake)))) || (*brake) > 0.0;
    if ( !__assertCondition ) 
    {
