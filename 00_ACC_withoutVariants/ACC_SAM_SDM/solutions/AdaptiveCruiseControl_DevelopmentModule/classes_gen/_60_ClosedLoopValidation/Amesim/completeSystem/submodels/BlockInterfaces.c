...
void  BlockInterfaces___testhelper____Test_ssd_safe_distance_TableUT_unittest(void *___data, void *___blockExecIfFn, void *___blockUpdateIfFn, int32_t *___failures) 
{
  ...
  (*((BlockInterfaces____ssd_safe_distance_computationInterface_newBlock_executeFunctionTypedef )(___blockExecIfFn)))(___id,v_acc_demo,v_lead,&d_safe);
  if ( ___blockUpdateIfFn != NULL ) 
  {
    (*((BlockInterfaces____ssd_safe_distance_computationInterface_newBlock_updateFunctionTypedef )(___blockUpdateIfFn)))(___id,v_acc_demo,v_lead);
  }
