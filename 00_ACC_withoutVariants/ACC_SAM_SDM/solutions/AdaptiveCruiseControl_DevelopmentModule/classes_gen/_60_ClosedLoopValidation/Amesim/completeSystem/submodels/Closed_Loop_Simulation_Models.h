...
struct Closed_Loop_Simulation_Models____control_flattened_data {
  ...
  Cla_Discrete____IntegratorICInt_data_t i_Integrator_;
  Cla_Discrete____IntegratorICInt_data_t i_Filter;
  ...
  Cla_Discrete____IntegratorICInt_data_t i_Integrator_1;
  Cla_Operators____Sum_data_t i_Sum_1;
  Cla_Operators____Gain_data_t i_P2;
  Cla_Operators____Gain_data_t i_I2;
  Cla_Discrete____IntegratorICInt_data_t i_Integrator_2;
